...
CREATE OR REPLACE FUNCTION "public"."convert_floating_item_to_credits"("p_item_id" "uuid", "p_user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."convert_floating_item_to_credits"("p_item_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_shop_order_by_claim_code"("code" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_shop_order_by_claim_code"("code" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."process_expired_vouchers"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."process_expired_vouchers"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."sync_claim_status_feed"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."sync_claim_status_feed"() OWNER TO "postgres";
...
ALTER TABLE "public"."claim_status_feed" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."order_items" (
    ...
    "child_claim_code" character varying,
    CONSTRAINT "order_items_allocated_price_check" CHECK (("allocated_price" >= 0)),
    CONSTRAINT "order_items_fulfillment_status_check" CHECK (("fulfillment_status" = ANY (ARRAY['PENDING'::"text", 'COLLECTED'::"text", 'MISSING'::"text", 'FLOATING'::"text", 'CONVERTED'::"text", 'EXPIRED'::"text"])))
);
...
ALTER TABLE ONLY "public"."claim_status_feed"
    ADD CONSTRAINT "claim_status_feed_pkey" PRIMARY KEY ("claim_code");
...
ALTER TABLE ONLY "public"."order_items"
    ADD CONSTRAINT "order_items_child_claim_code_key" UNIQUE ("child_claim_code");
...
CREATE INDEX "idx_shop_orders_recipient_phone" ON "public"."shop_orders" USING "btree" ("recipient_phone") WHERE ("recipient_phone" IS NOT NULL);
...
CREATE OR REPLACE TRIGGER "sync_claim_status_feed_trigger" AFTER INSERT OR UPDATE OF "claim_status", "claim_code" ON "public"."shop_orders" FOR EACH ROW EXECUTE FUNCTION "public"."sync_claim_status_feed"();
...
CREATE POLICY "claim_status_feed_select" ON "public"."claim_status_feed" FOR SELECT TO "authenticated", "anon" USING (true);
...
CREATE POLICY "shop_orders_select" ON "public"."shop_orders" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
  ...
  WHERE (("t"."transaction_id" = "shop_orders"."transaction_id") AND ("t"."buyer_id" = "auth"."uid"())))) OR (EXISTS ( SELECT 1
   FROM "public"."merchant_shops" "ms"
  WHERE (("ms"."shop_id" = "shop_orders"."shop_id") AND ("ms"."user_id" = "auth"."uid"())))) OR (("recipient_phone" IS NOT NULL) AND ("recipient_phone" = ("auth"."jwt"() ->> 'phone'::"text"))) OR ("public"."current_user_role"() = 'admin'::"text")));
...
CREATE POLICY "transactions_select_buyer" ON "public"."transactions" FOR SELECT TO "authenticated" USING ((("buyer_id" = "auth"."uid"()) OR ((("auth"."jwt"() ->> 'phone'::"text") IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM "public"."shop_orders" "so"
  WHERE (("so"."transaction_id" = "transactions"."transaction_id") AND ("so"."recipient_phone" = ("auth"."jwt"() ->> 'phone'::"text")))))) OR ("public"."current_user_role"() = 'admin'::"text")));
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."claim_status_feed";
...
REVOKE ALL ON FUNCTION "public"."convert_floating_item_to_credits"("p_item_id" "uuid", "p_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."convert_floating_item_to_credits"("p_item_id" "uuid", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."convert_floating_item_to_credits"("p_item_id" "uuid", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."convert_floating_item_to_credits"("p_item_id" "uuid", "p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_shop_order_by_claim_code"("code" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_shop_order_by_claim_code"("code" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_shop_order_by_claim_code"("code" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."process_expired_vouchers"() TO "anon";
GRANT ALL ON FUNCTION "public"."process_expired_vouchers"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_expired_vouchers"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."sync_claim_status_feed"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_claim_status_feed"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_claim_status_feed"() TO "service_role";
...
GRANT ALL ON TABLE "public"."claim_status_feed" TO "anon";
GRANT ALL ON TABLE "public"."claim_status_feed" TO "authenticated";
GRANT ALL ON TABLE "public"."claim_status_feed" TO "service_role";
