...
const AdminEscrow = lazyPage(() => import('./pages/admin/AdminEscrow'), 'AdminEscrow');
    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-50 p-6">
      <div className="w-full max-w-md rounded-2xl border border-ink-200 bg-white p-8 text-center shadow-sm">
        ...
        <button
          ...
          className="rounded-full bg-ink-900 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-ink-800"
        >
          Reload Page
        </button>
      </div>
