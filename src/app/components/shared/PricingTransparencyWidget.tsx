...
export function PricingTransparencyWidget({
  ...
  return (
    <div className="bg-ink-50/80 border border-ink-200/60 rounded-2xl p-4 space-y-3.5 shadow-sm">
      <div className="flex items-center justify-between border-b border-ink-100 pb-2">
        <h4 className="text-xs font-semibold text-ink-700 uppercase tracking-wider flex items-center gap-1.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {/* Local buyer */}
        <div className="bg-white border border-ink-100 rounded-xl p-3 flex flex-col justify-between">
          <span className="text-[10px] font-medium text-ink-400 uppercase tracking-wide flex items-center gap-1">
            Local Buyer Pays
            <span className="text-[9px] text-ink-400 font-normal normal-case">
              (+{rates.local}% fee)
            </span>
          </span>
          <span className="text-sm font-semibold text-ink-900 mt-1">
        ...
        <div className="bg-white border border-ink-100 rounded-xl p-3 flex flex-col justify-between">
          ...
          <span className="text-sm font-semibold text-ok-600 mt-1">
