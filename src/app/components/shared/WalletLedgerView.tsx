    ...
    <div className="space-y-6">
      ...
      >
        <Card className="overflow-hidden border-white/20 bg-white/40 backdrop-blur-xl shadow-lg ring-1 ring-black/5 rounded-3xl relative">
          <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-brand-300 via-brand-400 to-brand-300 opacity-80" />
          <CardContent className="p-8">
            <div className="flex items-center gap-4 text-ink-500 mb-2">
            ...
            <div className="text-4xl sm:text-5xl font-light tracking-tight text-ink-900">
      ...
      >
        <Card className="border-white/20 bg-white/40 backdrop-blur-xl shadow-sm ring-1 ring-black/5 rounded-3xl overflow-hidden">
          <CardHeader className="border-b border-ink-100/50 bg-white/30 px-6 py-5">
            <CardTitle className="text-lg font-medium text-ink-800 flex items-center gap-2">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className={`flex h-10 w-10 items-center justify-center rounded-full ${isCredit ? 'bg-ok-100/50 text-ok-600' : 'bg-danger-100/50 text-danger-600'}`}>
                          ...
                          <div className={`font-medium ${isCredit ? 'text-ok-600' : 'text-ink-900'}`}>
