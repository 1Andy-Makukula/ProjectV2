...
export function ProfileVerificationBanner({ onComplete }: ProfileVerificationBannerProps) {
  ...
  return (
    ...
    >
      <Alert className="rounded-none border-x-0 border-t-0 border-b-2 border-primary bg-orange-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center gap-4">
            <div className="flex-shrink-0">
              <div className="w-10 h-10 rounded-full kl-gradient-brand-br flex items-center justify-center">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start gap-2">
                <AlertCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" strokeWidth={1.5} />
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onComplete}
              className="flex-shrink-0 px-4 py-2 kl-gradient-brand text-white rounded-full font-light text-sm shadow-md"
            >
              Complete Profile
            </motion.button>
          </div>
